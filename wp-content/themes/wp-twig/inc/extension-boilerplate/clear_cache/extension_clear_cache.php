...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_clear_cache' ) ) {


    /**
     * Main ReduxFramework clear_cache extension class
     *
     * @since       3.1.6
     */
    class ReduxFramework_extension_clear_cache {

        // Set the version number of your extension here
        public static $version       = '1.0.0';

        // Set the name of your extension here
        public $ext_name             = 'Custom Field';
